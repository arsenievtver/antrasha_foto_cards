...
class Category(Base):
    ...
    Берём только ветки «Мужская коллекция», «Женская коллекция» и аксессуары
    (закупочно: муж / жен, в МойСклад — одна корневая папка).
    Онлайн / Товар ТО / РАДУГА и прочее в закупках не участвуют.
    """
